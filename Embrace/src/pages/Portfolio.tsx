...
import geminiImg from '@/assets/Custom.png';
...
import p7Img from '@/assets/portfolio-3.jpg';
...
const projects = [
  // REFINING (6)
  { img: f4Img, title: 'Molten Pour', cat: 'Refining', desc: 'Precision gold casting into industrial molds' },
  { img: p1Img, title: 'Diamond Selection', cat: 'Refining', desc: 'Raw and brilliant-cut diamonds in luxury display' },
  { img: p7Img, title: 'Heritage Necklace', cat: 'Refining', desc: 'Bespoke diamond and gold statement piece' },
  { img: p2Img, title: 'Masterpiece Collection', cat: 'Refining', desc: 'Curated emerald-cut diamond gallery display' },
  { img: p4Img, title: 'Asscher Solitaire', cat: 'Refining', desc: 'Monumental Asscher-cut diamond in vault presentation' },
  { img: g13Img, title: 'Signature Cuban', cat: 'Refining', desc: 'Heavy-gauge gold link with mirror-polish finish' },

  // CASTING (6)
  { img: g12Img, title: 'Cuban Bracelet', cat: 'Casting', desc: 'Miami Cuban link with high-security box clasp' },
  { img: g14Img, title: 'Pyramid Signet', cat: 'Casting', desc: 'Architectural 18K gold ring with center diamond' },
  { img: g16Img, title: 'Cuban Heirloom', cat: 'Casting', desc: 'Solid gold chain with crown-engraved insignia' },
  { img: g17Img, title: 'Divine Icon', cat: 'Casting', desc: 'Diamond-encrusted Jesus piece on heavy gold chain' },
  { img: p5Img, title: 'Radiant Twist', cat: 'Casting', desc: 'Radiant-cut diamond in rose gold infinity swirl' },
  { img: geminiImg, title: 'Celestial Signet', cat: 'Casting', desc: '3D-engineered 18K gold star-motif signet' },
  // CUSTOM (6)
  { img: f1Img, title: 'Artisan Band Set', cat: 'Custom', desc: '24K Four distinct gold bands with diamond accents' },
  { img: f3Img, title: 'Signature Link', cat: 'Custom', desc: 'Classic heavy-gauge gold link chain with a high-polish finish' },
  { img: g15Img, title: 'Monarch Cuban', cat: 'Custom', desc: 'Substantial 10K gold chain with a crown-engraved box clasp' },
  { img: g18Img, title: 'Channel Solitaire', cat: 'Custom', desc: 'Round brilliant diamond in an 18K channel-set diamond band' },
  { img: p3Img, title: 'Jewelry Showcase', cat: 'Custom', desc: 'Bespoke diamond rings featuring oval and emerald master-cuts' },
  { img: p6Img, title: 'Stardust Cuff', cat: 'Custom', desc: 'Polished white gold cuff with star-set brilliant diamonds' },
];
          ...
          >
            ...
            >
              ...
              <div className="grid gap-0 md:grid-cols-[1.15fr_1fr]">
                <div className="relative min-h-[320px] h-full overflow-hidden md:min-h-[560px]">
                  <img
                    src={selected.img}
                    alt={selected.title}
